const { backspaceRegex, findInstancesInCharacterArray, getPatternAndFlags } = require("../src/index");
...
describe("handleEscapes", () => {
    it("should handle backspace", () => {
        ...
        expect(handleEscapes({backspaces, currentChar, index, nextChar, regex, unicodeMode})).toEqual({
            index: index + 1,
            token: {
